...
Een PWA zijn webapplicaties die gebruik maken van moderne webtechnologieën om op deze manier een ervaring aan te bieden die dicht die van een native applicatie ligt.
...
\section{Onderzoeksvraag}
	...
	Deze thesis zal een antwoord bieden op de vraag: "welke functies van een besturingssysteem zijn beschikbaar voor progressive web applications". 
