...
\subsection{Betrokkenheid}
	...
	Push notificaties kunnen gebruikers herinneren om een bepaalde applicatie terug te gebruiken. 
...
\subsection{Deployment}
	...
	Uit het interview met zowel Thomas Steiner als bij Wassim Chegham blijkt dat het onafhankelijk zijn van een app-store een grote meerwaarde is. Ze haalden beide aan dat de iOS waarmee een PWA gehost en geüpdatet kan worden een uniek voordeel is.
	(appendix~\ref{ch:Interview})
