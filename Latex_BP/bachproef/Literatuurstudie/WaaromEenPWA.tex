...
\end{center}
	...
	Eén van de grootste voordelen is dat de PWA (versie 118) op het moment van schrijven slechts een grootte heeft van 397KB (figuur \ref{fig:tinderPWA}). De native Android applicatie (versie 11.8.1) daarentegen neemt 130MB (figuur \ref{fig:tinderApp}) in beslag op een toestel.
