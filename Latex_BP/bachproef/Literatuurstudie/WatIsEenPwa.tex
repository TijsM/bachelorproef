...
\label{ch: Voorbeelden}
	...
	\subsubsection{Starbucks}
		...
		Dit werd opgelost door de functionaliteit die de native applicatie biedt ook te implementeren als een PWA zodat deze gebruikt kanworden via het web zonder geïnstalleerd te worden.
