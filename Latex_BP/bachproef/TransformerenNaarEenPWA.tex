...
\end{lstlisting}
		...
		\newpage
		De naam en de verkorte naam (naam die op het splashscreen getoond zal worden) worden als eerste vastgelegd. Deze zijn gelijk omdat de volledige naam al kort genoeg is. Het maximum aantal karakters voor 'short\_name' is 12.
		...
		Er moet een link gemaakt worden van de hHTMLtml-bestanden naar dit manifest bestand. Dit gebeurt binnen de head tag van de index.html file.
