\chapter{Ombouwen webapplicatie tot een PWA}
...
\begin{lstlisting}[
	caption={app manifest vanjes darts PWA},
	label=manifestDarts]
{
  "short_name": "Dart 501",
  "name": "Dart 501",
...
\end{lstlisting}
		...
		In code voorbeeld \ref{manifestDarts} is het volledige app manifest van deze proof-of-concept te zien. De naam en de verkorte naam (naam die op het splashscreen getoond zal worden) worden als eerste vastgelegd. Deze zijn gelijk omdat de volledige naam al kort genoeg is. Het maximum aantal karakters voor 'short\_name' is 12.
...
\section{Controle}
	...
	Aan de hand van een lighthouse audit (figuur \ref{fig:auditDarts}) kan er gecontroleerd worden of alles werkt zoals verwacht.
