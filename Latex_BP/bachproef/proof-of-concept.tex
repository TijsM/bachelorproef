...
%todo: OV's overlopen in de conclusie
	...
	\subsection{Gebruik van PWA's}
		%todo: resultaat van user testing - zou de gebruiker app installeren
		%todo: resultaat van user testing - zou de gebruiker notificaties toestaan
		
	
	\subsection{Native vs PWA}
		%todo: wanneer zou een gebruiker een pwa gebruiken ipv een native app
		%todo: zou e
