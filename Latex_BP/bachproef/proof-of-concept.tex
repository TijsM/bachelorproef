...
%todo: OV's overlopen in de conclusie
	...
	\subsection{Compatibiliteit en besturingssystemen}
		Zoals eerder aangehaald is een van de nadelen van PWA's de sterk variërende ondersteuning van browsers. Voor deze reden is het belangrijk dat de applicatie ontwikkeld wordt aan de hand van progressive enhancement. 
