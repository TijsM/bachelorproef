...
\section{Conclusie}
	...
	\subsection{Compatibiliteit en besturingssystemen}
		...
		\begin{itemize}
	  		...
	  		\item Push notificaties heeft ook de toestemming van de gebruiker nodig en zijn beschikbaar op alle browsers en toestellen met uitzondering van:
	  				\begin{itemize}
	...
	\subsection{Beperkingen van een PWA}
		...
		Zo werd er werd beslist om de maximale hoogte van de applicatie vast te zetten op 100vh,  op deze manier is het in principe onmogelijk om een scroll te hebben.
		...
		Er zouden optimalisaties gedaan kunnen worden aan de hand van JavaScript. Ook Ionic zou eventueel een oplossing kunnen bieden. Deze oplossing verhogen in ieder geval de complexiteit en vallen buiten de scope van dit onderzoek.
